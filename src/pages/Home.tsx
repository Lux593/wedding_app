  ...
  return (
    <div className="space-y-8 md:space-y-16">
      ...
      <section className="relative">
        <h2 className="text-3xl md:text-4xl font-serif font-semibold text-center mb-12 text-gray-900 dark:text-white">
          {t('home.discover')}
        </h2>
          ...
          {quickLinks.map((link) => {
            ...
            return (
              <Link
                key={link.path}
                to={link.path}
                className="group relative p-6 bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-2xl hover:border-gold-400 dark:hover:border-gold-500 transition-all hover:shadow-xl hover:-translate-y-1 overflow-hidden"
              >
                <div className="flex items-center space-x-4 relative z-10">
                  <div className="p-4 bg-gradient-to-br from-cream-100 to-cream-200 dark:from-cream-700/30 dark:to-cream-600/30 rounded-xl group-hover:from-gold-500 group-hover:to-gold-600 dark:group-hover:from-gold-600 dark:group-hover:to-gold-700 transition-all shadow-md group-hover:shadow-lg group-hover:scale-110">
                    <Icon className="w-6 h-6 text-gold-600 dark:text-gold-400 group-hover:text-white transition-colors" />
                  </div>
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-1 group-hover:text-gold-600 dark:group-hover:text-gold-400 transition-colors">
                      {t(link.key)}
                    </h3>
