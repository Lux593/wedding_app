...
const translations: Record<Language, Record<string, string>> = {
  de: {
    ...
    'outfits.recommendations': 'Empfehlungen',
    ...
    'outfits.color.navy': 'Marine',
    'outfits.color.charcoal': 'Anthrazit',
    'outfits.color.sand': 'Sand',
    'outfits.color.ivory': 'Elfenbein',
    'outfits.color.blush': 'Blush',
    'outfits.color.champagne': 'Champagner',
  ...
  en: {
    ...
    'outfits.recommendations': 'Recommendations',
    ...
    'outfits.color.navy': 'Navy',
    'outfits.color.charcoal': 'Charcoal',
    'outfits.color.sand': 'Sand',
    'outfits.color.ivory': 'Ivory',
    'outfits.color.blush': 'Blush',
    'outfits.color.champagne': 'Champagne',
    ...
    'tips.subheader': 'Our tips for restaurants, activities and sights in Zurich',
    'tips.restaurants': 'Restaurants',
    'tips.activities': 'Activities',
    'tips.sightseeing': 'Sightseeing',
    'tips.restaurant.name1': 'Restaurant Kronenhalle',
    'tips.restaurant.desc1': 'Traditional Swiss restaurant with excellent cuisine and historic ambiance.',
    'tips.restaurant.name2': 'Lake Restaurant Quai 61',
    'tips.restaurant.desc2': 'Modern restaurant directly on Lake Zurich with wonderful views.',
    'tips.activity.name1': 'Boat Trip on Lake Zurich',
    'tips.activity.desc1': 'Relaxing cruise with wonderful views of the city and the Alps.',
    'tips.activity.name2': 'Hike to Uetliberg',
    'tips.activity.desc2': 'Zurich\'s local mountain offers a fantastic panoramic view over the city and the lake.',
    'tips.sightseeing.name1': 'Grossmünster',
    'tips.sightseeing.desc1': 'The famous church is one of Zurich\'s landmarks with impressive architecture.',
    'tips.sightseeing.name2': 'Bahnhofstrasse',
    'tips.sightseeing.desc2': 'One of the most exclusive shopping streets in the world with luxury stores and cafés.',
  ...
  fr: {
    ...
    'outfits.recommendations': 'Recommandations',
    ...
    'outfits.oneOutfit': 'tenue',
    'outfits.outfits': 'tenues',
    ...
    'outfits.color.navy': 'Bleu marine',
    'outfits.color.charcoal': 'Anthracite',
    'outfits.color.sand': 'Sable',
    'outfits.color.ivory': 'Ivoire',
    'outfits.color.blush': 'Blush',
    'outfits.color.champagne': 'Champagne',
    ...
    // Tips
    'tips.title': 'Conseils & Recommandations',
    'tips.subheader': 'Nos conseils pour les restaurants, les activités et les sites touristiques à Zurich',
    'tips.restaurants': 'Restaurants',
    'tips.activities': 'Activités',
    'tips.sightseeing': 'Sites touristiques',
    'tips.restaurant.name1': 'Restaurant Kronenhalle',
    'tips.restaurant.desc1': 'Restaurant suisse traditionnel avec une excellente cuisine et une ambiance historique.',
    'tips.restaurant.name2': 'Restaurant du lac Quai 61',
    'tips.restaurant.desc2': 'Restaurant moderne directement sur le lac de Zurich avec de belles vues.',
    'tips.activity.name1': 'Croisière sur le lac de Zurich',
    'tips.activity.desc1': 'Croisière relaxante avec de magnifiques vues sur la ville et les Alpes.',
    'tips.activity.name2': 'Randonnée à l\'Uetliberg',
    'tips.activity.desc2': 'La montagne locale de Zurich offre une vue panoramique fantastique sur la ville et le lac.',
    'tips.sightseeing.name1': 'Grossmünster',
    'tips.sightseeing.desc1': 'L\'église célèbre est l\'un des monuments de Zurich avec une architecture impressionnante.',
    'tips.sightseeing.name2': 'Bahnhofstrasse',
    'tips.sightseeing.desc2': 'L\'une des rues commerçantes les plus exclusives du monde avec des boutiques de luxe et des cafés.',
